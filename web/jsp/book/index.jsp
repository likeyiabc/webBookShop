			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="images/book/banner1.jpg" alt="Image 1">
					</div>
					<div class="item">
						<img src="images/book/banner2.jpg" alt="Image 2">
					</div>
					<div class="item">
						<img src="images/book/banner3.jpg" alt="Image 3">
					</div>
					<div class="item">
						<img src="images/book/banner4.jpg" alt="Image 4">
					</div>
					<div class="item">
						<img src="images/book/banner5.jpg" alt="Image 5">
					</div>
				</div>
			</div>
		</div>
